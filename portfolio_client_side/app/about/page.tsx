...
export const metadata: Metadata = {
  title: 'About Tonny Blair Nyauke - Zuriscale Founder & Fullstack Developer',
  description: 'Self-taught fullstack JavaScript engineer building Zuriscale, a SaaS platform for boutique owners in Kenya. From electrical engineering to software development in Homa Bay.',
  keywords: [
    'Tonny Blair Nyauke',
    'Zuriscale founder',
    'fullstack JavaScript engineer Kenya',
    'self-taught developer',
    'boutique software Kenya',
    'Homa Bay developer'
  ],
  openGraph: {
    title: 'About Tonny Blair Nyauke - Zuriscale Founder',
    description: 'Self-taught developer building SaaS solutions for boutique owners in Kenya',
  ...
  alternates: {
    canonical: 'https://tonnynyauke.com/about',
  },
};
...
const personJsonLd = {
  ...
  jobTitle: 'Fullstack JavaScript Engineer & Founder',
  ...
  knowsAbout: ['Next.js', 'Node.js', 'TypeScript', 'Tailwind CSS', 'Supabase'],
  sameAs: [
...
const AboutPage: React.FC = () => {
  return (
    <>
      {/* Structured Data Script - ONLY ADDITION */}
      <script
      ...
      {/* Your existing code - ONLY semantic HTML tags changed */}
      <main className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-slate-900 dark:via-slate-800 dark:to-indigo-900">
        <article className="max-w-4xl mx-auto px-6 py-16">
          ...
          {/* Main Story */}
          <section className="prose prose-lg max-w-none text-gray-700 dark:text-gray-300 mb-16" aria-label="My journey and story">
            <article className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl mb-8">
          ...
          {/* What Drives Me */}
          <section className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl mb-12" aria-label="What drives me and my interests">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6 flex items-center">
          ...
          {/* Current Focus */}
          <section className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl mb-12" aria-label="Current activities and focus areas">
          ...
          {/* Call to Action */}
          <aside className="text-center bg-gradient-to-r from-blue-500 to-indigo-600 rounded-2xl p-8 shadow-xl" aria-label="Contact and connect">
            ...
            <div className="flex justify-center space-x-4">
              ...
              <Link 
                href="https://www.linkedin.com/in/tonnynyauke" target='_blank'
                className="flex items-center px-6 py-3 bg-white text-blue-600 rounded-lg font-semibold hover:bg-blue-50 transition-colors duration-200"
              >
